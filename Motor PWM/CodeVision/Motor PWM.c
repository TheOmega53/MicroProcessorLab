...
while (1)
      ...
      // Place your code here
        ...
        if(read_adc(0) > 612){
            ...
            PORTD.0 = 1;
            PORTD.1 = 0;              
            temp = (read_adc(0) - 512)/ 2;
        }else if((read_adc(0) >= 412) && (read_adc(0) <= 612)){
            //PORTD = (0<PORTD0) | (0<PORTD1);
            PORTD.0 = 0;
            PORTD.1 = 0;
            temp = 0;
        }else if (read_adc(0) < 412){
            //PORTD = (0<PORTD0) | (1<PORTD1);
            PORTD.0 = 0;
            PORTD.1 = 1;
            temp = (((read_adc(0) - 512) + 1) / -2);
        }  
        ...
        OCR1A =  temp; 
           ...
           if(delay_time++ > 1000){
             ...
             result = read_adc(0);     
             lcd_gotoxy(12,0);     
             test = arr[result/1000%10];
             lcd_putchar(arr[result/1000%10]);
             lcd_gotoxy(13,0);
             lcd_putchar(arr[result/100%10]);
             lcd_gotoxy(14,0);
             lcd_putchar(arr[result/10%10]);
             lcd_gotoxy(15,0);
             lcd_putchar(arr[result%10]);             
                  
             lcd_gotoxy(12,1);     
             test = arr[OCR1AL/1000%10];
             lcd_putchar(arr[OCR1AL/1000%10]);
             lcd_gotoxy(13,1);
             lcd_putchar(arr[OCR1AL/100%10]);
             lcd_gotoxy(14,1);
             lcd_putchar(arr[OCR1AL/10%10]);
             lcd_gotoxy(15,1);
             lcd_putchar(arr[OCR1AL%10]);
