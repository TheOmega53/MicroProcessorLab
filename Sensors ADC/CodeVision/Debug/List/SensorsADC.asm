...
_0x0:
	...
	.DB  0x65,0x3A,0x0,0x54,0x68,0x72,0x65,0x73
	.DB  0x68,0x6F,0x6C,0x64,0x3A,0x0
_0x2000003:
...
; 0000 0014     threshhold = result;
	LDS  R30,_result_G000
	LDS  R31,_result_G000+1
	STS  _threshhold_G000,R30
	STS  _threshhold_G000+1,R31
; 0000 0015 
...
_0xB:
	LDS  R30,_threshhold_G000
	LDS  R31,_threshhold_G000+1
	LDS  R26,_result_G000
	LDS  R27,_result_G000+1
	CP   R26,R30
	CPC  R27,R31
...
SUBOPT_0x0:
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
	LDS  R26,_threshhold_G000
	LDS  R27,_threshhold_G000+1
	RET
